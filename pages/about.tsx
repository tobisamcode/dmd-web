    ...
    <div className="relative">
      ...
      <section className=" mt-[5rem] pb-[5rem] md:pb-[7.6rem] p-0 ">
        <div className="container ">
          <h1 className="mb-[1.5rem] lg:mb-[3.12rem] text-black-black_11 font-helvetica font-[700] text-[2rem] lg:text-[3rem] ">
            About Me
          </h1>
          ...
          <div className="flex flex-col md:flex-row items-center gap-[5rem] md:gap-[9.12rem] ">
            <div className="flex flex-col lg:first-letter md:w-[53%]">
              <p className="text-black-black_10 text-[1.125rem] md:text-[1.5rem] font-[500] mb-[2rem] ">
                I’m Moses Denapo aka “DMD”, a digital product designer with
                expertise creating user interfaces for both mobile and web
                applications.
              </p>

              <p className="text-black-black_8 text-[.875rem] md:text-[1.125rem] font-[400]">
              ...
              <p className="text-black-black_8 text-[.875rem] md:text-[1.125rem] font-[400] mt-[2rem] ">
            ...
            <div className="flex flex-col md:w-[35%] text-center text-black-black_10 ">
              <p
      ...
      <section className="pt-0 lg:pt-[5rem]">
        <div className="container">
          <h1 className=" self-center lg:self-start text-[2rem] lg:text-[48px] font-[700] text-black-black_10 font-helvetica mb-[2.12rem] lg:mb-[3.12rem] ">
          ...
          <div className="flex md:justify-end   ">
            <div className="w-full md:w-[70%] flex flex-col gap-y-[1.25rem] border border-[#EBEBEB] rounded-[1rem] py-[2rem] px-[1rem] lg:py-[2.5rem] lg:px-[5rem] bg-[#FAFAFA] ">
              {Experinces.map(({ id, role, company, from, to, border }) => (
                <div
                  key={id}
                  className={`flex pb-[1.25rem] ${border} lg:gap-[7.5rem] lg:items-center justify-between`}
                >
                  <div className="flex gap-2 lg:gap-4 lg:w-[70%]">
                    <h1 className=" text-black-black_10 text-[1.125rem] lg:text-[1.5rem] font-[700] ">
                      {id}.
                    </h1>

                    <div className="flex flex-col  gap-[.5rem]">
                      <p className=" text-black-black_10 text-[1.125rem] lg:text-[1.5rem] font-[500] lg:font-[700]">
                        {role}
                      </p>
                      <p className="text-black-black_8 text-[.875rem] lg:text-[1.125rem] font-[500] ">
                        {company}
                      </p>
                    </div>
                  </div>

                  <div className="flex  flex-col lg:flex-row  w-[50%] lg:w-[50%] gap-[.12rem] md:gap-4 justify-center items-center text-black-black_8 text-[.875rem] lg:text-[1.125rem] font-[400] lg:font-[500]">
